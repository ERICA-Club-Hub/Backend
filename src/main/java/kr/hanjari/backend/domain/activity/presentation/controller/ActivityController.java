package kr.hanjari.backend.domain.activity.presentation.controller;
...
public class ActivityController {
    ...
    @Operation(summary = "[활동로그] 최근 업로드 된 활동로그 조회", description = """
            ## 최근 업로드 된 활동로그를 조회합니다..
            
            """)
    @GetMapping("/club/recent")
    public ApiResponse<RecentActivityLogResponse> getRecentActivities() {
        return ApiResponse.onSuccess(activityService.getRecentActivities());
    }

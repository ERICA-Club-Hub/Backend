...
public class ClubController {
  ...
  public ApiResponse<ClubCommandResponse> acceptClubRegistration(
  ...
  public ApiResponse<ClubCommandResponse> updateClubInfo(
      @RequestPart ClubBasicInformationRequest requestBody,
      @RequestPart MultipartFile image,
    ...
    return ApiResponse.onSuccess(
        clubCommandService.updateClubBasicInformation(clubId, requestBody, image));
  }
  ...
  public ApiResponse<ScheduleListResponse> postClubSchedules(
    ...
    return ApiResponse.onSuccess(
        clubCommandService.saveAndUpdateClubSchedule(clubId, clubActivityDTO));
  }
  ...
  public ApiResponse<ClubScheduleDraftResponse> postClubSchedulesDraft(
      ...
      @RequestBody ClubScheduleListRequest clubActivityDTO) {
    return ApiResponse.onSuccess(
        clubCommandService.saveAndUpdateClubScheduleDraft(clubId, clubActivityDTO));
  }
  ...
  public ApiResponse<ClubCommandResponse> postClubIntroduction(
    ...
    return ApiResponse.onSuccess(
        clubCommandService.saveClubIntroduction(clubId, clubIntroductionDTO));
  }
  ...
  public ApiResponse<ClubIntroductionDraftResponse> getClubIntroductionDraft(
      @PathVariable Long clubId) {
  ...
  public ApiResponse<ClubCommandResponse> postClubIntroductionDraft(
      ...
      @RequestBody ClubIntroductionRequest clubIntroductionDTO) {
    return ApiResponse.onSuccess(
        clubCommandService.saveClubIntroductionDraft(clubId, clubIntroductionDTO));
  }
  ...
  public ApiResponse<ClubCommandResponse> postClubRecruitment(
    ...
    return ApiResponse.onSuccess(
        clubCommandService.saveClubRecruitment(clubId, clubRecruitmentDTO));
  }
  ...
  public ApiResponse<ClubRecruitmentDraftResponse> getClubRecruitmentDraft(
      @PathVariable Long clubId) {
  ...
  public ApiResponse<ClubCommandResponse> postClubRecruitmentDraft(
      ...
      @RequestBody ClubRecruitmentRequest clubRecruitmentDTO) {
    return ApiResponse.onSuccess(
        clubCommandService.saveClubRecruitmentDraft(clubId, clubRecruitmentDTO));
  }

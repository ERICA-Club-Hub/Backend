...
public class ClubQueryServiceImpl implements ClubQueryService {
  ...
  @Override
  public ClubSearchResponse findCentralClubsByCondition(String keyword, RecruitmentStatus status,
      SortBy sortBy,
  ...
  @Override
  public ClubSearchResponse findUnionClubsByCondition(String keyword, RecruitmentStatus status,
      SortBy sortBy,
  ...
  @Override
  public ClubSearchResponse findCollegeClubsByCondition(String keyword, RecruitmentStatus status,
      SortBy sortBy,
  ...
  @Override
  public ClubSearchResponse findDepartmentClubsByCondition(String keyword, RecruitmentStatus status,
      SortBy sortBy,
  ...
  public ClubDetailListResponse findClubsByCondition(
    ...
    Page<Club> clubs = clubRepository.findAll(
        ClubSpecifications.findByCondition(name, category, status), pageable);
    for (Club club : clubs) {
      profileImageUrls.add(s3Service.getDownloadUrl(club.getImageFile().getId()));
    }
